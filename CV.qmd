...
df = pd.read_excel('data/experiences.xlsx', sheet_name='sections')
...
def print_language_skills(language='PT'):
...
[github/mmfava/resume](https://github.com/mmfava/resume), `{python} data_formatada`
 <br>
</small></div>
